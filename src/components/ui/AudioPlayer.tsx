  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <button
        onClick={togglePlay}
        disabled={isLoading}
        className="transition-colors cursor-pointer text-cf-text-primary hover:text-cf-accent disabled:opacity-50"
      ...
      <div className="flex-1 flex items-center gap-2">
        <span className="text-xs text-cf-text-secondary min-w-[30px] tabular-nums">
        ...
        <input
          ...
          className={`flex-1 h-1 rounded-cf-sm appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-cf-accent ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
